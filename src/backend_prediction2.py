...
def predict():
    ...
    model_filename = 'Training/saved_models/Emotion_Voice_Detection_Model4.h5'

    loaded_model = tf.keras.models.load_model(model_filename)

    for (dirpath, dirnames, filenames) in os.walk("demo/temp_fragment"):
